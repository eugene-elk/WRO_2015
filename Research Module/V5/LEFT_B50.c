...
void input()
{
	...
	motor[Bur2] = 100;
	while((SensorValue[Touch1] == 0) && (SensorValue[Touch2] == 0)){
		if(((nMotorEncoder[Bur1] > 8000) || (nMotorEncoder[Bur2] > 8000)) && (abs(nMotorEncoder[Bur1] - nMotorEncoder[Bur2]) > 2200)) pos7();
		wait1Msec(1);
	}
	ClearTimer(T1);
	while(time1[T1] < 4000){
		...
		if((SensorValue[Touch1] == 1) && (SensorValue[Touch2] == 1)) break;
		if(((nMotorEncoder[Bur1] > 7000) || (nMotorEncoder[Bur2] > 7000)) && (abs(nMotorEncoder[Bur1] - nMotorEncoder[Bur2]) > 1500)) pos7();
		wait1Msec(1);
	}
